...
class DatabricksClient:
    ...
    #     # Usar PAT token directamente si está disponible
    #     pat_token = os.getenv("DATABRICKS_TOKEN")
    #     if pat_token:
    #         print("[DATABRICKS_CLIENT] Token obtenido via DATABRICKS_TOKEN")
    #         return pat_token

    #     # Fallback: Service Principal (solo para workspace compartido)
